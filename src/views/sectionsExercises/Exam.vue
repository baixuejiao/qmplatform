            ...
            if(this.isChoice){
                ...
                if(x && x == answer){//如果当前选中的选项 == 正确答案  当前选项的样式success
                    ...
                    this.$refs.message.show({
                        message:{title:'恭喜你回答正确，正确答案是：'+answer,content:this.nowQuestion.answerDesc},
                        type:'success'
                    });
                    ...
                    this.$refs.countTimer.stopTimeCount();
                    this.$refs.message.show({
                        message:{title:'对不起回答错误，正确答案是：'+answer,content:this.nowQuestion.answerDesc},
                        type:'error'
                    });
                }else if(x == ""){
