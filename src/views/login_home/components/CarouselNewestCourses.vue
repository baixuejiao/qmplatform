        ...
        >
          <ul class="carousel-inner">
            <li
              ...
              v-for="(items,index) in newListArr"
              :key="index"
            >
              <div>
          ...
          <a
            ...
            href="#carouselExampleControls_nc"
            role="button"
            data-slide="prev"
          >
